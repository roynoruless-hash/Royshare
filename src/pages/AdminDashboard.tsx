...
export default function AdminDashboard() {
  ...
  const setDiagnosticStatus = () => {};
  const diagnosticLogs = [];
  const setDiagnosticLogs = () => {};
  const verifyScript = (val?: any) => {};
  ...
  const [shortenerSubTab, setShortenerSubTab] = useState<"self" | "user">(
    "self",
  );
  ...
  const [userShortenerSettingsLoading, setUserShortenerSettingsLoading] =
    useState(false);
  const [userShortenerSettingsSaving, setUserShortenerSettingsSaving] =
    useState(false);
        ...
        <div className="space-y-8 max-w-7xl mx-auto">
                      ...
                      <div className="border-t border-slate-800 pt-6 space-y-4">
                        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 border-b border-slate-850 pb-2">
                          <h4 className="text-base font-bold text-slate-200">
                            📢 Dynamic OnClickA Banner Manager
                          </h4>
                          <span className="text-xs text-slate-500 font-mono">
                            Setup multi-position OnClickA Banners for landing
                            pages
                          </span>
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          <div>
                            <label className="block text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">
                              Enable Banner Ads Globally
                            </label>
                            <select
                              id="banner-ads-enabled"
                              value={
                                userShortenerSettings.bannerAdsEnabled !== false
                                  ? "true"
                                  : "false"
                              }
                              onChange={(e) =>
                                setUserShortenerSettings((prev: any) => ({
                                  ...prev,
                                  bannerAdsEnabled: e.target.value === "true",
                                }))
                              }
                              className="w-full bg-slate-950 border border-slate-800 rounded-xl px-4 py-2.5 text-sm text-white focus:outline-none focus:border-indigo-500"
                            >
                        ...
                        {userShortenerSettings.totalBannerAds > 0 && (
                          <div className="bg-slate-950 border border-slate-850 rounded-xl p-5 space-y-4">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                              {(
                                userShortenerSettings.onclickaBanners || []
                              ).map((banner: any, index: number) => {
                                return (
                                  <div
                                    key={index}
                                    className="bg-slate-900 border border-slate-800 rounded-xl p-4 space-y-3.5 relative"
                                  >
                                    ...
                                    <div className="space-y-3.5">
                                      <div>
                                        ...
                                        {!adSettings.onclickaSpots ||
                                        adSettings.onclickaSpots.length ===
                                          0 ? (
                                          <div className="text-[10px] bg-rose-950/40 border border-rose-500/25 rounded px-2.5 py-1.5 text-rose-400 font-semibold leading-tight">
                                            ⚠️ No Spot IDs configured! Go to Ads
                                            Settings → OnClickA to add Spot IDs
                                            first.
                                          </div>
                                        ) : (
                                          <select
                                      ...
                                      <div>
                                        ...
                                        >
                                          ...
                                          <option value="Above Timer">
                                            Above Timer
                                          </option>
                                          <option value="Below Timer">
                                            Below Timer
                                          </option>
                                          <option value="Above Verify">
                                            Above Verification Card
                                          </option>
                                          <option value="Below Verify">
                                            Below Verification Card
                                          </option>
                                          <option value="Above Continue">
                                            Above Continue Button
                                          </option>
                                          <option value="Below Continue">
              ...
              <div className="flex flex-col md:flex-row justify-between gap-4 items-center border-b border-slate-800 pb-4">
                <div>
                  ...
                  <p className="text-slate-400 text-sm">
                    Control advertisements globally across RoyShare Earn without
                    redeploying code.
                  </p>
                </div>
                <div className="flex items-center gap-2">
                    ...
                    <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-6">
                        ...
                        <select
                          ...
                          onChange={(e) => {
                            ...
                            setAdSettings({
                              ...
                              network: val,
                              enabled:
                                val !== "disabled" ? adSettings.enabled : false,
                            });
                          }}
                          className="w-full bg-slate-950 border border-slate-700 rounded-xl px-4 py-3 text-white font-bold focus:outline-none focus:border-indigo-500"
                        >
                          <option value="disabled">None (Disabled)</option>
                          <option value="onclicka">
                            OnClickA Banner Network
                          </option>
                          <option value="ezmob">EZMob Outstream Video</option>
                          <option value="custom">Custom Script</option>
                        </select>
                        <p className="text-xs text-slate-500">
                          Choose the active ad provider network. Select 'None
                          (Disabled)' to turn off all monetization.
                        </p>
                      </div>
                      ...
                      <div className="flex justify-between items-center bg-slate-950 p-4 rounded-xl border border-slate-800">
                        <div>
                          ...
                          <p className="text-xs text-slate-500">
                            Toggle all system advertisements ON or OFF globally.
                          </p>
                        </div>
                        <button
                          type="button"
                      ...
                      <div className="space-y-2">
                        ...
                        ></textarea>
                        <p className="text-xs text-slate-500">
                          Provide the official script tag. Changing this script
                          resets the verification status.
                        </p>
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <textarea
                          ...
                          onChange={(e) =>
                            setAdSettings({
                              ...adSettings,
                              bannerContainerCode: e.target.value,
                            })
                          }
                        ...
                        ></textarea>
                        <p className="text-xs text-slate-500">
                          Paste the HTML banner container provided by the ad
                          network.
                        </p>
                      </div>
                        ...
                        <button
                          ...
                          onClick={() => {
                            ...
                            setAdSettingsFeedback(
                              "Script cleared. Click 'Save Script' to save this change.",
                            );
                          }}
                    ...
                    <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-6">
                      ...
                      <div className="space-y-4">
                        <div className="bg-slate-950 p-4 rounded-xl border border-slate-800 flex justify-between items-center">
                          ...
                          <span
                            className={`px-2 py-1 rounded text-xs font-bold ${adSettings.enabled ? "bg-emerald-500/10 text-emerald-400 border border-emerald-500/20" : "bg-rose-500/10 text-rose-400 border border-rose-500/20"}`}
                          >
                        ...
                        <div className="bg-slate-950 p-4 rounded-xl border border-slate-800 flex justify-between items-center">
                          ...
                          <span
                            className={`px-2 py-1 rounded text-xs font-bold ${adSettings.verified ? "bg-emerald-500/10 text-emerald-400 border border-emerald-500/20" : "bg-amber-500/10 text-amber-400 border border-amber-500/20"}`}
                          >
                      ...
                      <div className="bg-slate-950/40 border border-slate-800/60 rounded-xl p-4 space-y-2 text-xs text-slate-400">
                        ...
                        <p>
                          1. Paste script snippet from your ad network
                          dashboard.
                        </p>
                        <p>
                          2. Verify script validity with{" "}
                          <strong>Verify Script</strong> button.
                        </p>
                        <p>
                          3. Save the active configurations with{" "}
                  ...
                  <div className="lg:col-span-2 space-y-6">
                    <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-6">
                      <h3 className="text-lg font-bold text-white border-b border-slate-800 pb-3 flex items-center gap-2 font-sans tracking-tight">
                        <span>📺</span> EZMob Outstream Video Campaign
                        Configuration
                      </h3>
                      ...
                      <div className="flex justify-between items-center bg-slate-950 p-4 rounded-xl border border-slate-800">
                        <div>
                          ...
                          <p className="text-xs text-slate-500">
                            Toggle EZMob Outstream Video Ads globally at last
                            step of shorteners.
                          </p>
                        </div>
                        <button
                          ...
                          onClick={() =>
                            setAdSettings({
                              ...adSettings,
                              ezmobEnabled: !adSettings.ezmobEnabled,
                            })
                          }
                        ...
                        <div className="space-y-2">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setAdSettings({
                                ...adSettings,
                                ezmobPrebidScript: e.target.value,
                              })
                            }
                        ...
                        <div className="space-y-2">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setAdSettings({
                                ...adSettings,
                                ezmobRendererScript: e.target.value,
                              })
                            }
                            className="w-full bg-slate-950 border border-slate-850 rounded-xl px-4 py-2.5 text-sm text-white focus:outline-none focus:border-indigo-500 font-mono text-xs"
                        ...
                        <div className="space-y-2">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setAdSettings({
                                ...adSettings,
                                ezmobContainerId: e.target.value,
                              })
                            }
                            className="w-full bg-slate-950 border border-slate-850 rounded-xl px-4 py-2.5 text-sm text-white focus:outline-none focus:border-indigo-500 font-mono text-xs"
                        ...
                        <div className="space-y-2">
                          ...
                          <select
                            ...
                            onChange={(e) =>
                              setAdSettings({
                                ...adSettings,
                                ezmobVpaidMode: e.target.value === "true",
                              })
                            }
                            className="w-full bg-slate-950 border border-slate-850 rounded-xl px-4 py-2.5 text-sm text-white focus:outline-none focus:border-indigo-500 font-mono text-xs"
                          >
                            <option value="true">
                              VPAID Allowed (Default)
                            </option>
                            <option value="false">
                              No VPAID (Linear Only)
                            </option>
                          </select>
                        </div>
                      </div>
                          ...
                          <div className="flex gap-4">
                            <label className="flex items-center gap-2 text-xs text-slate-300 cursor-pointer">
                              <input
                                ...
                                value="auto"
                                checked={
                                  adSettings.ezmobPlayerSizeMode === "auto"
                                }
                                onChange={() =>
                                  setAdSettings({
                                    ...adSettings,
                            ...
                            <label className="flex items-center gap-2 text-xs text-slate-300 cursor-pointer">
                              <input
                                ...
                                value="width"
                                checked={
                                  adSettings.ezmobPlayerSizeMode === "width"
                                }
                                onChange={() =>
                                  setAdSettings({
                                    ...adSettings,
                                    ezmobPlayerSizeMode: "width",
                                  })
                                }
                                className="accent-indigo-500"
                              />
                            ...
                            <label className="flex items-center gap-2 text-xs text-slate-300 cursor-pointer">
                              <input
                                ...
                                value="height"
                                checked={
                                  adSettings.ezmobPlayerSizeMode === "height"
                                }
                                onChange={() =>
                                  setAdSettings({
                                    ...adSettings,
                                    ezmobPlayerSizeMode: "height",
                                  })
                                }
                                className="accent-indigo-500"
                              />
                          ...
                          <div className="flex gap-4">
                            <label className="flex items-center gap-2 text-xs text-slate-300 cursor-pointer">
                              <input
                                ...
                                value="floating"
                                checked={
                                  adSettings.ezmobDisplayMode === "floating"
                                }
                                onChange={() =>
                                  setAdSettings({
                                    ...adSettings,
                            ...
                            <label className="flex items-center gap-2 text-xs text-slate-300 cursor-pointer">
                              <input
                                ...
                                value="inline"
                                checked={
                                  adSettings.ezmobDisplayMode === "inline"
                                }
                                onChange={() =>
                                  setAdSettings({
                                    ...adSettings,
                                    ezmobDisplayMode: "inline",
                                  })
                                }
                                className="accent-indigo-500"
                              />
                      ...
                      <div className="flex justify-between items-center bg-slate-950 p-4 rounded-xl border border-slate-800">
                        <div>
                          ...
                          <p className="text-[11px] text-slate-500">
                            Apply elegant expand/collapse animations to
                            outstream player viewport transitions.
                          </p>
                        </div>
                        <button
                          type="button"
                          onClick={() =>
                            setAdSettings({
                              ...adSettings,
                              ezmobEnableTransitions:
                                !adSettings.ezmobEnableTransitions,
                            })
                          }
                    ...
                    <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-4">
                      ...
                      <div className="space-y-2 text-xs font-mono">
                        <div className="bg-slate-950 p-2.5 rounded border border-slate-850 flex justify-between">
                          ...
                          <span className="text-slate-300 font-bold">
                            {ezmobDiagnostics.container || "Uninitialized"}
                          </span>
                        </div>
                        <div className="bg-slate-950 p-2.5 rounded border border-slate-850 flex justify-between">
                          <span className="text-slate-500">Prebid SDK</span>
                          <span className="text-slate-300 font-bold">
                            {ezmobDiagnostics.sdk || "Not Loaded"}
                          </span>
                        </div>
                        <div className="bg-slate-950 p-2.5 rounded border border-slate-850 flex justify-between">
                          <span className="text-slate-500">Auction Engine</span>
                          <span className="text-slate-300 font-bold">
                            {ezmobDiagnostics.auction || "Idle"}
                          </span>
                        </div>
                        <div className="bg-slate-950 p-2.5 rounded border border-slate-850 flex justify-between">
                          <span className="text-slate-500">
                        ...
                        <div className="bg-slate-950 p-2.5 rounded border border-slate-850 flex justify-between">
                          ...
                          <span
                            className={`font-bold ${ezmobTestState === "PLAYING" ? "text-emerald-400" : "text-slate-400"}`}
                          >
                            {ezmobDiagnostics.status || "Idle"}
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="bg-slate-950 rounded-xl p-4 font-mono text-[11px] h-64 overflow-y-auto border border-slate-850 space-y-1.5 text-slate-300">
                        {ezmobTestLogs.length === 0 ? (
                          <div className="text-slate-600 italic text-center py-20">
                            Console idle. Click 'Run Test Preview' to trigger.
                          </div>
                        ) : (
                          ezmobTestLogs.map((log, idx) => (
                            <div
                              key={idx}
                              className="leading-relaxed break-all border-b border-slate-900 pb-1 last:border-b-0"
                            >
                              {log}
                            </div>
                          ))
                  ...
                  <div className="lg:col-span-2 space-y-6">
                    <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-6">
                      ...
                      <div className="flex justify-between items-center bg-slate-950 p-4 rounded-xl border border-slate-800">
                        <div>
                          <label className="block text-sm font-semibold text-white">
                            1. Enable OnClickA Ads
                          </label>
                          <p className="text-xs text-slate-500">
                            Toggle OnClickA system ads globally across all smart
                        ...
                        <button
                          ...
                          onClick={() =>
                            setAdSettings({
                              ...adSettings,
                              onclickaEnabled: !adSettings.onclickaEnabled,
                            })
                          }
                          className={`px-4 py-2 rounded-xl text-xs font-bold transition-all duration-200 shadow-md cursor-pointer ${
                      ...
                      <div className="space-y-2">
                        <label className="block text-sm font-semibold text-slate-300">
                          2. Centralized Publisher Script
                        </label>
                        <textarea
                          ...
                          onChange={(e) =>
                            setAdSettings({
                              ...adSettings,
                              onclickaSdkScript: e.target.value,
                            })
                          }
                        ...
                        <div className="flex justify-between items-center text-xs text-slate-500">
                          <span>
                            Paste the global SDK script code. Only one SDK
                            script instance will be loaded to prevent
                            duplication.
                          </span>
                          {(() => {
                            ...
                            const pidMatch =
                              script.match(
                                /data-admpid\s*=\s*["']([^"']+)["']/i,
                              ) || script.match(/data-admpid\s*=\s*([0-9]+)/i);
                            const autoPublisherId = pidMatch
                              ? pidMatch[1]
                              : null;
                      ...
                      <div className="space-y-4 pt-4 border-t border-slate-800">
                        <div className="flex justify-between items-center">
                          <div>
                            <h4 className="text-md font-bold text-slate-200">
                              🚀 Dynamic Spot Manager
                            </h4>
                            <p className="text-xs text-slate-500">
                              Create and manage unlimited ad spot configurations
                            </p>
                          </div>
                          <button
                            type="button"
                        ...
                        {(() => {
                          ...
                          (adSettings.onclickaSpots || []).forEach((s: any) => {
                            if (s.spotId) {
                              spotIdCounts[s.spotId] =
                                (spotIdCounts[s.spotId] || 0) + 1;
                            }
                          });
                          ...
                          return hasDuplicates ? (
                            <div className="p-3 bg-rose-950/40 border border-rose-500/20 rounded-xl text-xs text-rose-400 flex items-center gap-2">
                              ...
                              <span>
                                Warning: Duplicate Spot IDs detected! Ensure
                                each Spot ID configuration is unique to prevent
                                rendering overlap conflicts.
                              </span>
                            </div>
                          ) : null;
                        })()}
                            ...
                            {(adSettings.onclickaSpots || []).map(
                              (spot: any) => {
                                ...
                                const updateSpotField = (
                                  ...
                                  setAdSettings({
                                    ...adSettings,
                                    onclickaSpots: updated,
                                  });
                                };

                                const dupWarning =
                                  spot.spotId &&
                                  (adSettings.onclickaSpots || []).filter(
                                    (s: any) => s.spotId === spot.spotId,
                                  ).length > 1;

                                return (
                                  <div
                                    key={spot.id}
                                    className="bg-slate-950 rounded-xl border border-slate-800 p-5 space-y-4 hover:border-slate-700 transition duration-150"
                                  >
                                      ...
                                      <div className="bg-slate-900/80 p-3 rounded-lg border border-slate-850 space-y-2 animate-fadeIn">
                                        ...
                                        <div className="border border-dashed border-slate-800 p-2 rounded bg-slate-950 flex justify-center items-center overflow-hidden">
                                          <OnClickABanner
                                            ...
                                            sdkScript={
                                              adSettings.onclickaSdkScript
                                            }
                                            sizeMode={spot.sizeMode}
                                            size={
                                              spot.size === "Custom"
                                                ? `${spot.customW}x${spot.customH}`
                                                : spot.size
                                            }
                                            position={
                                              spot.name || "Preview Spot"
                                            }
                                            bannerNumber={1}
                                            onDiagnosticUpdate={(diagData) => {
                                              setSpotDiagnostics((prev) => ({
                                                ...prev,
                                                [spot.id]: diagData,
                                              }));
                                            }}
                                        ...
                                        <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                                          ...
                                          <div className="bg-slate-950 p-2 rounded border border-slate-900">
                                            ...
                                            <span className="font-mono font-bold text-emerald-400">
                                              {diag.detectedWidth
                                                ? `${diag.detectedWidth}x${diag.detectedHeight}`
                                                : "Awaiting Render"}
                                            </span>
                                          </div>
                                          <div className="bg-slate-950 p-2 rounded border border-slate-900">
                                            ...
                                            <span
                                              className={`font-semibold ${diag.sdkLoaded ? "text-emerald-400" : "text-slate-500"}`}
                                            >
                                              {diag.sdkLoaded
                                                ? "Successfully Loaded"
                                                : "Pending Load"}
                                          ...
                                          <div className="bg-slate-950 p-2 rounded border border-slate-900">
                                            ...
                                            <span
                                              className={`font-semibold ${diag.fillStatus === "Filled" ? "text-emerald-400" : diag.fillStatus === "Checking" ? "text-amber-400" : "text-rose-400"}`}
                                            >
                                              {diag.fillStatus}
                                            </span>
                                          </div>
                    ...
                    <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-4">
                      ...
                      <div className="space-y-3 text-xs">
                        <div className="flex justify-between items-center bg-slate-950 p-3 rounded-xl border border-slate-800">
                          ...
                          <span
                            className={`px-2 py-0.5 rounded text-[10px] font-bold ${adSettings.onclickaEnabled ? "bg-emerald-500/10 text-emerald-400 border border-emerald-500/20" : "bg-rose-500/10 text-rose-400 border border-rose-500/20"}`}
                          >
                        ...
                        <div className="flex justify-between items-center bg-slate-950 p-3 rounded-xl border border-slate-800">
                          ...
                          <span className="font-bold text-slate-200 font-mono">
                            {(adSettings.onclickaSpots || []).length} Spots
                          </span>
                        </div>
                        <div className="flex justify-between items-center bg-slate-950 p-3 rounded-xl border border-slate-800">
                          <span className="text-slate-400 font-medium">
          ...
          {modalAction !== "none" &&
            (selectedWithdrawal ||
              selectedTicket ||
              selectedUser ||
              modalAction.includes("announcement") ||
              modalAction.includes("task") ||
              modalAction === "preview_ad" ||
              modalAction.includes("smart_link")) && (
              <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
                <div
                  className={`bg-slate-900 border border-slate-700 rounded-2xl w-full ${modalAction.includes("smart_link") ? "max-w-2xl" : "max-w-md"} overflow-hidden shadow-2xl flex flex-col`}
                >
                  <div className="p-5 border-b border-slate-800 flex justify-between items-center bg-slate-950/50">
                    <h3 className="text-lg font-bold text-white flex items-center gap-2">
                      {modalAction === "view_withdrawal" &&
                        "👁 Withdrawal Details"}
                      ...
                      {modalAction === "create_announcement" &&
                        "➕ Create Announcement"}
                      {modalAction === "edit_announcement" &&
                        "✏️ Edit Announcement"}
                      {modalAction === "view_announcement" &&
                      ...
                      {modalAction === "create_smart_link" &&
                        "🔗 Create Smart Link"}
                      {modalAction === "edit_smart_link" &&
                        "✏️ Edit Smart Link"}
                    </h3>
                    <button
                    ...
                    {modalAction === "view_withdrawal" && selectedWithdrawal ? (
                      <div className="space-y-4">
                        ...
                        <div className="bg-slate-800/50 rounded-xl p-3 space-y-2">
                          <p className="text-xs text-slate-400">
                            ...
                            <span className="text-white ml-1">
                              {selectedWithdrawal.firstName}{" "}
                              {selectedWithdrawal.lastName}
                            </span>
                          </p>
                          <p className="text-xs text-slate-400">
                            📛 Username:{" "}
                            <span className="text-white ml-1">
                              @{selectedWithdrawal.username || "N/A"}
                            </span>
                          </p>
                          <p className="text-xs text-slate-400">
                            🆔 Telegram ID:{" "}
                        ...
                        {(selectedWithdrawal.method === "USDT" ||
                          selectedWithdrawal.method === "USDT (TRC20)") &&
                          selectedWithdrawal.networkFee !== undefined && (
                            <div className="grid grid-cols-3 gap-2">
                              <div className="bg-slate-800/30 rounded-lg p-2 text-center">
                                ...
                                <p className="font-mono text-xs text-red-400">
                                  -{selectedWithdrawal.networkFee} USDT
                                </p>
                              </div>
                              <div className="bg-slate-800/30 rounded-lg p-2 text-center">
                                <p className="text-[10px] text-slate-400 mb-1">
                                ...
                                <p className="font-mono text-xs text-red-400">
                                  -{selectedWithdrawal.marketAdjustmentFee} USDT
                                </p>
                              </div>
                              <div className="bg-slate-800/50 rounded-lg p-2 text-center border border-emerald-500/20">
                                ...
                                <p className="font-bold text-xs text-emerald-400">
                                  {selectedWithdrawal.finalReceive} USDT
                                </p>
                              </div>
                            </div>
                          )}
                        ...
                        {selectedWithdrawal.verificationStatus && (
                          <div className="bg-slate-950 border border-slate-800 rounded-xl p-4">
                            <h4 className="text-sm font-bold text-white mb-3 border-b border-slate-800 pb-2">
                              Human Verification
                            </h4>
                            <div className="space-y-2 text-sm">
                              ...
                              <p>
                                ...
                                <span className="text-white">
                                  {selectedWithdrawal.verificationMethod}
                                </span>
                              </p>
                              <p>
                                ...
                                <span className="text-white">
                                  {new Date(
                                    selectedWithdrawal.verificationTime,
                                  ).toLocaleString()}
                                </span>
                              </p>
                            </div>
                        ...
                        <div className="bg-slate-950 border border-slate-800 rounded-xl p-4">
                          ...
                          {(selectedWithdrawal.method === "UPI ID" ||
                            ...
                            <div className="space-y-3">
                              <p className="text-sm flex flex-col gap-1">
                                ...
                                <span className="font-mono bg-slate-900 p-2 rounded border border-slate-800">
                              ...
                              <button
                                ...
                                className="text-xs bg-slate-800 hover:bg-slate-700 text-slate-300 px-3 py-1.5 rounded transition-colors flex items-center gap-1 w-fit"
                              >
                                📋 Copy UPI ID
                              </button>
                            </div>
                          )}
                          {(selectedWithdrawal.method === "Bank Account" ||
                                ...
                                <div className="flex items-center justify-between bg-slate-900 p-2 rounded border border-slate-800">
                                  ...
                                  <button
                                    onClick={() => {
                                      ...
                                      alert("Copied Account Holder Name!");
                                    }}
                                    className="text-xs bg-slate-800 hover:bg-slate-700 text-slate-300 px-2 py-1 rounded transition-colors"
                                  >
                                    📋 Copy
                          ...
                          {(selectedWithdrawal.method === "USDT (TRC20)" ||
                            ...
                            <div className="space-y-3">
                              <p className="text-sm flex flex-col gap-1">
                                ...
                                <span className="font-mono bg-slate-900 p-2 rounded border border-slate-800 break-all">
                      ...
                      <div className="space-y-4">
                        ...
                        <p className="text-sm text-slate-400">
                          This will notify the user that their request has been
                        ...
                        <div>
                          ...
                          <select
                            ...
                            onChange={(e) => {
                              ...
                              if (type === "upi")
                                setModalInput("Wrong UPI ID Details");
                              else if (type === "bank")
                                setModalInput("Wrong Bank Account Details");
                              else if (type === "usdt")
                                setModalInput("Wrong USDT TRC20 Address");
                              else setModalInput("");
                            }}
                          ...
                          >
                            <option value="upi">
                              Wrong UPI ID (
                              {systemSettings?.withdrawalTaxSettings?.upiTax ??
                                5}
                              % Tax)
                            </option>
                            <option value="bank">
                              Wrong Bank Account (
                              {systemSettings?.withdrawalTaxSettings?.bankTax ??
                                10}
                              % Tax)
                            </option>
                            <option value="usdt">
                              Wrong USDT TRC20 Address (
                              {systemSettings?.withdrawalTaxSettings?.usdtTax ??
                                15}
                              % Tax)
                            </option>
                            <option value="other">
                              Other (Manual Reason / No Tax)
                            </option>
                          </select>
                        </div>
                        ...
                        {rejectionType !== "other" && (
                          <div className="bg-red-500/10 border border-red-500/20 rounded-xl p-3">
                            ...
                            <p className="text-[10px] text-slate-500 italic leading-tight">
                              Note: Tax will be deducted permanently. The
                              remaining amount will be refunded to user's
                        ...
                        <div className="bg-slate-900 border border-slate-800 rounded-xl p-3.5 space-y-3">
                          <div className="flex justify-between items-center">
                            ...
                            <button
                              type="button"
                              onClick={() =>
                                handleTicketAiAnalyze(selectedTicket.id)
                              }
                          ...
                          {selectedTicket.aiSummary ? (
                            ...
                            <p className="text-[11px] text-slate-500 leading-relaxed italic">
                              No AI Analysis run on this ticket yet. Click the
                              button to summarize, detect the category, and
                          ...
                          {selectedTicket.replies &&
                            selectedTicket.replies.map(
                              (rep: any, idx: number) => (
                                <div
                                  key={idx}
                                  className={`p-2.5 rounded-lg border ${rep.sender === "admin" ? "bg-blue-950/20 border-blue-900/20 ml-3" : "bg-slate-900/40 border-slate-800 mr-3"}`}
                                >
                                  <div className="flex justify-between items-center mb-1">
                                    <span
                                      className={`text-[11px] font-bold ${rep.sender === "admin" ? "text-blue-400" : "text-indigo-400"}`}
                                    >
                                      {rep.sender === "admin"
                                        ? "🛡️ Admin Reply"
                                        : "👤 User Reply"}
                      ...
                      <div className="space-y-4">
                        <div className="flex justify-between items-center">
                          ...
                          <button
                            type="button"
                            onClick={() =>
                              handleTicketAiSuggestReply(selectedTicket.id)
                            }
                            disabled={aiReplying}
                      ...
                      <div className="space-y-4">
                        ...
                        <p className="text-sm text-slate-400">
                          This will mark the issue as resolved and notify the
                          user.
                        </p>
                      </div>
                          ...
                          <div>
                            ...
                            <input
                              ...
                              onChange={(e) =>
                                setSmartLinkForm({
                                  ...smartLinkForm,
                                  finalRedirectDelay: Number(e.target.value),
                                })
                              }
                              className="w-full bg-slate-950 border border-slate-700 rounded-xl px-4 py-1.5 text-white focus:outline-none focus:border-indigo-500 text-xs"
                            />
                        ...
                        {smartLinkForm.totalPages > 0 && (
                          <div className="space-y-4 border-t border-slate-800 pt-4 mt-4">
                            <h4 className="text-xs font-bold text-slate-300">
                              ⚙️ Multi-Page Monetization Configurations
                            </h4>
                            <div className="space-y-4 max-h-[220px] overflow-y-auto pr-2">
                              {Array.from({
                                length: smartLinkForm.totalPages,
                              }).map((_, index) => {
                                const pageNum = index + 1;
                                let pConfig = smartLinkForm.pagesConfig.find(
                                ...
                                return (
                                  <div
                                    key={pageNum}
                                    className="bg-slate-950 p-3 rounded-xl border border-slate-850 space-y-3"
                                  >
                                    <div className="flex justify-between items-center">
                                      <span className="font-bold text-xs text-indigo-400">
                                        Page {pageNum} Settings
                                      </span>
                                      <label className="flex items-center gap-1.5 text-xs text-slate-400 cursor-pointer">
                                        <input
                                          ...
                                          onChange={(e) => {
                                            ...
                                            config.humanVerification =
                                              e.target.checked;
                                            if (idx >= 0) updated[idx] = config;
                                    ...
                                    <div className="space-y-3 text-xs">
                                      ...
                                      <div className="pt-1">
                                        <label className="block text-slate-400 mb-1.5 font-semibold">
                                          Active Ads (Grouped by Network)
                                        </label>
                                        {(() => {
                                          const activeAds = ads.filter(
                                            (ad) =>
                                              ad.status === "🟢 Active" ||
                                              String(ad.status).includes(
                                                "Active",
                                              ) ||
                                              String(ad.status).includes("🟢"),
                                          );
                                          if (activeAds.length === 0) {
                                            return (
                                              <p className="text-[10px] text-slate-500 bg-slate-900 p-2 rounded border border-slate-800 text-center">
                                                No Active Ads in Ads Manager.
                                              </p>
                                            );
                                          }
                                          ...
                                          sortedNetworks.forEach((network) => {
                                            groupedAds[network].sort((a, b) => {
                                              const typeCompare = (
                                                a.adType || ""
                                              ).localeCompare(b.adType || "");
                                              if (typeCompare !== 0)
                                                return typeCompare;
                                              return (
                                                a.adName || ""
                                              ).localeCompare(b.adName || "");
                                            });
                                          });
                                              ...
                                              {sortedNetworks.map((network) => (
                                                ...
                                                >
                                                  ...
                                                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-1.5">
                                                    {groupedAds[network].map(
                                                      (ad: any) => {
                                                        const isSelected = (
                                                          pConfig?.selectedAdIds ||
                                                          []
                                                        ).includes(ad.id);
                                                        return (
                                                          <label
                                                          ...
                                                          >
                                                            <input
                                                              ...
                                                              onChange={(e) => {
                                                                ...
                                                                if (
                                                                  ...
                                                                  if (
                                                                    !config.selectedAdIds
                                                                  )
                                                                    config.selectedAdIds =
                                                                      [];
                                                                  if (
                                                                    !config.selectedAdIds.includes(
                                                                      ad.id,
                                                                    )
                                                                  ) {
                                                                    config.selectedAdIds.push(
                                                                      ad.id,
                                                                    );
                                                                  }
                                                                } else {
                                                            ...
                                                            <div className="min-w-0 flex-1 truncate">
                                                              ...
                                                              <span className="text-[9px] text-indigo-400 ml-1.5 uppercase font-mono">
                                                                ({ad.adType})
                                                              </span>
                                                            </div>
                                                          </label>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          <div className="bg-slate-800/50 rounded-xl p-3">
                            ...
                            <p className="font-bold text-xl text-blue-400">
                              {(announcementForm as any).viewCount || 0}
                            </p>
                          </div>
                          <div className="bg-slate-800/50 rounded-xl p-3">
                            <p className="text-xs text-slate-400 mb-1">
                            ...
                            <p className="font-bold text-xl text-purple-400">
                              {(announcementForm as any).clickCount || 0}
                            </p>
                          </div>
                        </div>
                          ...
                          <div className="flex flex-col sm:flex-row gap-2 mb-2 bg-slate-950/60 p-3 rounded-xl border border-slate-800 shadow-xl">
                            <div className="flex-1 space-y-1">
                              ...
                              >
                                ...
                                <option value="Telegram Join">
                                  Telegram Join
                                </option>
                                <option value="YouTube Subscribe">
                                  YouTube Subscribe
                                </option>
                                <option value="YouTube Watch">
                                  YouTube Watch
                                </option>
                                <option value="Instagram Follow">
                                  Instagram Follow
                                </option>
                                <option value="Facebook Like">
                                  Facebook Like
                                </option>
                                <option value="Twitter/X Follow">
                                  Twitter/X Follow
                                </option>
                                <option value="Survey">Survey</option>
                                <option value="URL Shortener">
                                  URL Shortener
                                </option>
                                <option value="Daily Bonus">Daily Bonus</option>
                                <option value="Referral Task">
                                  Referral Task
                                </option>
                              ...
                              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                                ...
                                <div className="bg-slate-950/50 p-2 rounded-lg border border-indigo-500/10">
                                  ...
                                  <div className="text-sm font-bold text-blue-400">
                                    ₹
                                    {aiTaskSuggestion.task?.rewardAmount || "5"}
                                  </div>
                                </div>
                                <div className="bg-slate-950/50 p-2 rounded-lg border border-indigo-500/10">
                                  <div className="text-[10px] text-slate-500 font-bold uppercase">
                                  ...
                                  <div
                                    className={`text-sm font-bold ${aiTaskSuggestion.analytics?.risk === "Low" ? "text-emerald-400" : "text-amber-400"}`}
                                  >
                                    {aiTaskSuggestion.analytics?.risk || "Low"}
                                  </div>
                                </div>
                                <div className="bg-slate-950/50 p-2 rounded-lg border border-indigo-500/10">
                                  <div className="text-[10px] text-slate-500 font-bold uppercase">
                                  ...
                                  <div className="text-sm font-bold text-indigo-400">
                                    {aiTaskSuggestion.analytics?.difficulty ||
                                      "Medium"}
                                  </div>
                                </div>
                                <div className="bg-slate-950/50 p-2 rounded-lg border border-indigo-500/10">
                                ...
                                <div className="bg-slate-950/50 p-2 rounded-lg border border-indigo-500/10">
                                  ...
                                  <div className="text-sm font-bold text-purple-400">
                                    {aiTaskSuggestion.task?.adNetwork ||
                                      "Direct"}
                                  </div>
                                </div>
                              </div>
                                ...
                                {[
                                  {
                                    ...
                                    text: "Complete this reward task.",
                                    delay: 0.1,
                                  },
                                  {
                                    icon: (
                                  ...
                                  },
                                  {
                                    ...
                                    text: "Watch the advertisement completely.",
                                    delay: 0.3,
                                  },
                                  {
                                    icon: (
                                    ...
                                    text: "Please do not close or skip the ad.",
                                    delay: 0.4,
                                  },
                                  {
                                    icon: (
                                    ...
                                    text: "Unlock automatically after completion.",
                                    delay: 0.5,
                                  },
                                  {
                                    icon: (
                                    ...
                                    text: "Tap Claim Reward after verification.",
                                    delay: 0.6,
                                  },
                                ].map((item, i) => (
                                  <motion.div
                                ...
                                {[
                                  {
                                    ...
                                    text: "Do not close the Mini App while ad is playing.",
                                  },
                                  {
                                    icon: (
                                      <ShieldAlert
                                    ...
                                    text: "Skipping or closing ad will cancel reward.",
                                  },
                                  {
                                    icon: (
                                      <AlertCircle
                                    ...
                                    text: "VPN, Proxy and Emulators are strictly prohibited.",
                                  },
                                  {
                                    icon: (
                                      <CheckCircle2
                                    ...
                                    text: "Reward is credited only after successful completion.",
                                  },
                                ].map((item, i) => (
                                  <motion.div
                                    key={i}
                          ...
                          <>
                            <div>
                              <div className="flex justify-between items-center mb-1">
                                ...
                                <button
                                  onClick={() =>
                                    handleGenerateAiTask("description")
                                  }
                                  disabled={aiGeneratingTask}
                                  className="text-[10px] bg-slate-900 hover:bg-slate-800 text-indigo-400 px-2 py-0.5 rounded border border-slate-800 transition-colors flex items-center gap-1"
                                >
                            ...
                            <div className="grid grid-cols-2 gap-4">
                              <div>
                                <div className="flex justify-between items-center mb-1">
                                  ...
                                  <button
                                    onClick={() =>
                                      handleGenerateAiTask("rewardAmount")
                                    }
                                    disabled={aiGeneratingTask}
                              ...
                              <div>
                                <div className="flex justify-between items-center mb-1">
                                  ...
                                  <button
                                    onClick={() =>
                                      handleGenerateAiTask("timerDuration")
                                    }
                                    disabled={aiGeneratingTask}
                                    className="text-[10px] bg-slate-900 hover:bg-slate-800 text-indigo-400 px-2 py-0.5 rounded border border-slate-800 transition-colors"
                                  >
                            ...
                            <div className="grid grid-cols-2 gap-4">
                              <div>
                                <div className="flex justify-between items-center mb-1">
                                  ...
                                  <button
                                    onClick={() =>
                                      handleGenerateAiTask("totalPages")
                                    }
                                    disabled={aiGeneratingTask}
                                    className="text-[10px] bg-slate-900 hover:bg-slate-800 text-indigo-400 px-2 py-0.5 rounded border border-slate-800 transition-colors"
                                  >
                            ...
                            <div className="bg-slate-950/40 p-4 border border-slate-800 rounded-xl mt-3 space-y-3">
                              <div className="flex justify-between items-center pb-2 border-b border-slate-800">
                                <span className="text-xs font-bold text-slate-300 uppercase tracking-wider">
                                  🎯 Select {taskForm.adNetwork} Ads (Step 2)
                                </span>
                                <span className="text-[10px] text-slate-400 bg-slate-900 border border-slate-800 px-2 py-0.5 rounded-full font-bold">
                                  {
                                    ads.filter((ad) => {
                                      ...
                                      if (n === "adsterra" || n === "monetag") {
                                        return (
                                          adType.includes("banner") ||
                                          adType.includes("native") ||
                                          adType.includes("direct") ||
                              ...
                              <div className="max-h-48 overflow-y-auto space-y-2 pr-1">
                                {(() => {
                                  ...
                                  if (filteredAds.length === 0) {
                                    return (
                                      <div className="text-xs text-slate-500 italic py-2">
                                        No active {taskForm.adNetwork} ads
                                        matching supported types found in your
                                        Ads Manager.
                                      </div>
                                    );
                                  }
                                  ...
                                  return filteredAds.map((ad) => {
                                    const isSelected =
                                      taskForm.selectedAdIds?.includes(ad.id);
                                    return (
                                      <label
                                        key={ad.id}
                                        className="flex items-start gap-2.5 p-2 bg-slate-950/80 rounded-lg hover:bg-slate-800/40 cursor-pointer border border-slate-800/40 transition-all select-none"
                                      >
                                        <input
                                          type="checkbox"
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <input
                            ...
                            value={adForm.adName}
                            onChange={(e) =>
                              setAdForm({ ...adForm, adName: e.target.value })
                            }
                            className="w-full bg-slate-950 border border-slate-700 rounded-xl px-4 py-2.5 text-white focus:outline-none focus:border-blue-500"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                          ...
                          <div>
                            ...
                            <select
                              ...
                              onChange={(e) =>
                                setAdForm({ ...adForm, adType: e.target.value })
                              }
                              className="w-full bg-slate-950 border border-slate-700 rounded-xl px-4 py-2.5 text-white focus:outline-none focus:border-blue-500"
                            >
                              <option value="Banner Ad">Banner Ad</option>
                              <option value="Native Ad">Native Ad</option>
                              <option value="Direct Link Ad">
                                Direct Link Ad
                              </option>
                              <option value="VAST Video Ad">
                                VAST Video Ad
                              </option>
                              <option value="Interstitial Ad">
                                Interstitial Ad
                              </option>
                            </select>
                          </div>
                          <div>
                            ...
                            >
                              ...
                              <option value="Download Page">
                                Download Page
                              </option>
                              <option value="Withdraw Page">
                                Withdraw Page
                              </option>
                              <option value="URL Shortener">
                                URL Shortener
                          ...
                          <div>
                            ...
                            >
                              ...
                              <option value="Secondary Banner">
                                Secondary Banner
                              </option>
                              <option value="Native Slot 1">
                                Native Slot 1
                              </option>
                              <option value="Native Slot 2">
                                Native Slot 2
                              </option>
                              <option value="Footer Banner">
                                Footer Banner
                              </option>
                              <option value="Direct Link Button">
                                Direct Link Button
                              </option>
                        ...
                        <div>
                          ...
                          <textarea
                            ...
                            placeholder={
                              adForm.adType === "Direct Link Ad"
                                ? "https://..."
                                : `Paste your ${adForm.adSource} ad script code here...`
                            }
                          />
                          {showAdPreview &&
                            adForm.adType !== "Direct Link Ad" && (
                              <div className="mt-4">
                                <label className="text-sm font-medium text-slate-400 block mb-2 font-bold text-blue-400">
                                  🧪 Render Test Results
                                </label>
                                <div className="w-full bg-slate-900 border border-slate-700 rounded-xl overflow-hidden min-h-[150px] flex items-center justify-center text-slate-500 relative">
                                  ...
                                  {(adForm as any).scriptCode ? (
                                    <div className="text-sm text-slate-500 font-mono">
                                      Ad preview is disabled in the ad-free
                                      version.
                                    </div>
                                  ) : (
                                    "Empty Script"
                                ...
                                <div
                                  id="ad-preview-status"
                                  className="mt-2 text-xs p-2 bg-slate-950 border border-slate-800 rounded font-mono"
                                >
                                  Pending render...
                                </div>
                              </div>
                      ...
                      <div className="space-y-4">
                        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-4 space-y-4">
                          <div className="flex justify-between items-start">
                            ...
                            <span
                              className={`px-2 py-1 rounded text-xs font-bold shrink-0 ${taskForm.status === "🟢 Active" ? "bg-emerald-500/20 text-emerald-400" : "bg-red-500/20 text-red-400"}`}
                            >
                              {taskForm.status}
                            </span>
                          </div>
                          <div className="grid grid-cols-2 gap-4 pt-4 border-t border-slate-800">
                            ...
                            <div>
                              ...
                              <p className="font-medium text-white">
                                {(taskForm as any).participants || 0}
                              </p>
                            </div>
                          </div>
                          ...
                          {taskForm.adNetwork && (
                            <div className="pt-4 border-t border-slate-800 space-y-2">
                              ...
                              <div className="flex justify-between text-xs">
                                <span className="text-slate-500">
                                  🎯 Selected Ads (
                                  {taskForm.selectedAdIds?.length || 0})
                                </span>
                                  ...
                                  <div className="bg-slate-950/60 p-2.5 rounded-xl border border-slate-800 space-y-1.5 max-h-24 overflow-y-auto">
                                    {ads
                                      ...
                                      .map((ad) => (
                                        <div
                                          key={ad.id}
                                          className="text-[10px] text-slate-400 flex justify-between"
                                        >
                      ...
                      <div className="space-y-4 max-h-[60vh] overflow-y-auto pr-2 custom-scrollbar">
                        <div className="bg-slate-800/50 rounded-xl p-4 space-y-2">
                          <h3 className="text-sm font-black text-indigo-400 uppercase tracking-widest border-b border-slate-700/50 pb-2 mb-2">
                            👤 Identity & Referral Details
                          </h3>
                          <div className="grid grid-cols-2 gap-y-2">
                            <p className="text-[10px] text-slate-400">
                              Entered Name:{" "}
                              <span className="text-white font-bold ml-1">
                                {selectedUser.enteredName || "N/A"}
                              </span>
                            </p>
                            <p className="text-[10px] text-slate-400">
                              TG Username:{" "}
                            ...
                            <p className="text-[10px] text-slate-400">
                              Telegram ID:{" "}
                              <span className="font-mono text-white ml-1">
                                {selectedUser.telegramId || selectedUser.id}
                              </span>
                            </p>
                            <p className="text-[10px] text-slate-400">
                              Mobile Number:{" "}
                            ...
                            <p className="text-[10px] text-slate-400">
                              ...
                              <span className="text-pink-400 ml-1">
                                {selectedUser.referredBy || "None"}
                              </span>
                            </p>
                            <p className="text-[10px] text-slate-400">
                              Invite Code Used:{" "}
                              <span className="text-sky-400 font-bold ml-1">
                                {selectedUser.inviteCodeUsed || "None"}
                              </span>
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="bg-slate-800/50 rounded-xl p-4 space-y-2">
                          <h3 className="text-sm font-black text-emerald-400 uppercase tracking-widest border-b border-slate-700/50 pb-2 mb-2">
                            💰 Financial Status
                          </h3>
                          <div className="grid grid-cols-2 gap-3">
                        ...
                        <div className="bg-slate-800/50 rounded-xl p-4 space-y-2">
                          <h3 className="text-sm font-black text-slate-400 uppercase tracking-widest border-b border-slate-700/50 pb-2 mb-2">
                            ⚙️ System Info
                          </h3>
                          <div className="grid grid-cols-2 gap-y-2">
                            <p className="text-[10px] text-slate-400">
                            ...
                            <p className="text-[10px] text-slate-400">
                              Verified:{" "}
                              <span
                                className={`${selectedUser.verified || selectedUser.registrationStep === "completed" ? "text-emerald-400" : "text-red-400"} font-bold ml-1`}
                              >
                                {selectedUser.verified ||
                                selectedUser.registrationStep === "completed"
                                  ? "YES"
                                  : "NO"}
                              </span>
                            </p>
                        ...
                        <div className="grid grid-cols-2 gap-2 mt-4 pt-4 border-t border-slate-800">
                          <button
                            onClick={() => setModalAction("add_balance")}
                            className="py-2.5 bg-emerald-600/20 hover:bg-emerald-600/40 text-emerald-400 rounded-xl text-xs font-black transition-all border border-emerald-500/20"
                          >
                            💰 Add Balance
                          </button>
                          <button
                            onClick={() => setModalAction("deduct_balance")}
                            className="py-2.5 bg-red-600/20 hover:bg-red-600/40 text-red-400 rounded-xl text-xs font-black transition-all border border-red-500/20"
                          >
                            ➖ Deduct Balance
                          </button>
                          <button
                            onClick={() =>
                              handleUserAction(selectedUser.id, "reset-balance")
                            }
                            className="py-2.5 bg-yellow-600/20 hover:bg-yellow-600/40 text-yellow-500 rounded-xl text-xs font-black transition-all border border-yellow-500/20"
                          >
                            🔄 Reset Balance
                          </button>
                          <button
                            onClick={() => setModalAction("message_user")}
                            className="py-2.5 bg-indigo-600/20 hover:bg-indigo-600/40 text-indigo-400 rounded-xl text-xs font-black transition-all border border-indigo-500/20"
                          >
                            📨 Send Message
                          </button>
                          {selectedUser.status === "Banned" ? (
                            <button
                              onClick={() => setModalAction("unban_user")}
                              className="py-2.5 bg-blue-600/20 hover:bg-blue-600/40 text-blue-400 rounded-xl text-xs font-black transition-all border border-blue-500/20 col-span-2"
                            >
                              ✅ Unban User
                            </button>
                          ) : (
                            <button
                              onClick={() => setModalAction("ban_user")}
                              className="py-2.5 bg-slate-800 hover:bg-slate-700 text-slate-300 rounded-xl text-xs font-black transition-all border border-slate-700 col-span-2"
                            >
                              🚫 Ban User
                            </button>
                          )}
                          <button
                            onClick={() =>
                              handleUserAction(selectedUser.id, "reset")
                            }
                            className="py-2.5 bg-yellow-600/20 hover:bg-yellow-600/40 text-yellow-500 rounded-xl text-xs font-black transition-all border border-yellow-500/20"
                          >
                            🔄 Reset Progress
                          ...
                          <button
                            onClick={() =>
                              handleUserAction(selectedUser.id, "re-register")
                            }
                            className="py-2.5 bg-purple-600/20 hover:bg-purple-600/40 text-purple-400 rounded-xl text-xs font-black transition-all border border-purple-500/20"
                          >
                            ➕ Reset Registration
                          </button>
                          <button
                            ...
                            className="py-2.5 bg-red-600/20 hover:bg-red-600/40 text-red-400 rounded-xl text-xs font-black transition-all border border-red-500/20 col-span-2"
                          >
                      ...
                      <div className="space-y-4">
                        <div className="bg-red-500/10 border border-red-500/20 p-4 rounded-xl mb-4">
                          <p className="text-red-400 text-sm">
                            Are you sure you want to ban this user? They will
                            not be able to access the bot.
                          </p>
                        </div>
                        <div>
                          <label className="block text-sm font-medium text-slate-400 mb-1">
                            Ban Reason (Sent to user)
                          </label>
                          <textarea
                            onChange={(e) => setModalInput(e.target.value)}
                            className="w-full bg-slate-950 border border-slate-700 rounded-xl px-4 py-2.5 text-white h-24 resize-none"
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <textarea
                            ...
                            className="w-full bg-slate-950 border border-slate-700 rounded-xl px-4 py-2.5 text-white h-24 resize-none"
                            placeholder="Message content or media URL..."
                          />
                        </div>
                      </div>
                    ) : null}
                  ...
                  <div className="p-4 border-t border-slate-800 bg-slate-900 flex justify-end gap-3 mt-auto shrink-0">
                    <button
                      onClick={() => {
                        ...
                        if (
                          modalAction.endsWith("_ticket") &&
                          modalAction !== "view_ticket"
                        )
                          setModalAction("view_ticket");
                        else if (modalAction === "edit_announcement")
                          setModalAction("view_announcement");
                          ...
                          modalAction !== "view_withdrawal" &&
                          modalAction.endsWith("_withdrawal") &&
                          modalAction !== "view_withdrawal"
                        )
                          setModalAction("view_withdrawal"); // approximation
                    ...
                    >
                      ...
                      modalAction === "view_ticket" ||
                      modalAction === "view_announcement" ||
                      modalAction === "view_task" ||
                      modalAction === "view_user" ||
                      modalAction === "preview_ad"
                        ? "Close"
                        : modalAction === "create_ad" ||
                            modalAction === "edit_ad"
                    ...
                    {(modalAction === "create_smart_link" ||
                      ...
                      <button
                        onClick={handleActionSubmit}
                        disabled={
                          modalLoading || !smartLinkForm.destinationUrl.trim()
                        }
                    ...
                    {modalAction === "add_balance" && (
                      <button
                        onClick={handleActionSubmit}
                        disabled={
                          modalLoading || !JSON.parse(modalInput || "{}").amount
                        }
                        className="px-5 py-2 bg-emerald-600 hover:bg-emerald-500 text-white text-sm font-bold rounded-xl transition-all disabled:opacity-50"
                      >
